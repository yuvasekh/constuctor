...
import './Home.css'
 const Home = () => {
  ...
  <div class="card">
    ...
    <h3>Labour</h3>
    <p>Labour refers to the physical and mental effort that individuals put into work or production. It is a fundamental aspect of economics, and the availability and quality of labour can significantly impact economic growth and development. Labour can be categorized into different types, including skilled, unskilled, manual, and intellectual, depending on the nature of the work and the skills required.  The study of labour economics involves analyzing factors that affect labour supply and demand, labour market dynamics, and the impact of labour policies on the economy and society</p>
  </div>
  <div class="card">
